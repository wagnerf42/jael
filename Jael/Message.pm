...
BEGIN {
	require Exporter;
	@ISA = qw(Exporter);
	@EXPORT = qw(TASK_COMPUTATION_COMPLETED DEPENDENCIES_UPDATE_TASK_COMPLETED DEPENDENCIES_UPDATE_TASK_READY DATA_LOCALISATION DATA_LOCATED DATA_DUPLICATED END_ALL STEAL_REQUEST STEAL_FAILED STEAL_SUCCESS TASK_STOLEN FORK_REQUEST FORK_ACCEPTED FORK_REFUSED FILE_REQUEST FILE TASKGRAPH);
}
...
my @type_strings = qw(TASK_COMPUTATION_COMPLETED DEPENDENCIES_UPDATE_TASK_COMPLETED DEPENDENCIES_UPDATE_TASK_READY DATA_LOCALISATION DATA_LOCATED DATA_DUPLICATED END_ALL STEAL_REQUEST STEAL_FAILED STEAL_SUCCESS TASK_STOLEN FORK_REQUEST FORK_ACCEPTED FORK_REFUSED FILE_REQUEST FILE TASKGRAPH);
...
my @messages_format = qw(-1 0 0 0 0 1 0 2 2 2 0 0 0 0 0 0 3 3);
