...
BEGIN {
    require Exporter;
    @ISA = qw(Exporter);
    @EXPORT = qw(TASK_COMPUTATION_COMPLETED DEPENDENCIES_UPDATE_TASK_COMPLETED DEPENDENCIES_UPDATE_TASK_READY DATA_LOCALISATION DATA_LOCATED DATA_DUPLICATED END_ALL STEAL_REQUEST STEAL_FAILED STEAL_SUCCESS TASK_IS_PUSH FORK_REQUEST FORK_ACCEPTED FORK_REFUSED FILE_REQUEST FILE TASKGRAPH LAST_FILE);
}
...
my @type_strings = qw(TASK_COMPUTATION_COMPLETED DEPENDENCIES_UPDATE_TASK_COMPLETED DEPENDENCIES_UPDATE_TASK_READY DATA_LOCALISATION DATA_LOCATED DATA_DUPLICATED END_ALL STEAL_REQUEST STEAL_FAILED STEAL_SUCCESS TASK_IS_PUSH FORK_REQUEST FORK_ACCEPTED FORK_REFUSED FILE_REQUEST FILE TASKGRAPH LAST_FILE);
